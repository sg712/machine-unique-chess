...
EDITORIAL = {
    ...
    3: {"title": "Consider the pawn move before the capture", "prompt": "The bishop can capture the knight on e5. Is that the move you would choose?",
        "explanation": "Maia strongly favours ...Bxe5. Stockfish prefers ...g5, which supports Black's pawn on f4. In the alternative line, ...Bxe5 dxe5 ...Rxe5 clears the diagonal for White's bishop to capture on f4. The pawn move changes that tactical detail: a bishop taking on f4 would face ...gxf4. This is one concrete difference to inspect in the continuations, not a complete explanation of the engine evaluation. A quiet move can have a tactical purpose."},
